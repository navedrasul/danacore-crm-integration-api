# Contributing to DanaCore CRM Integration App API

First off, thanks for taking the time to contribute! The following is a set of guidelines for contributing to DanaCore CRM Integration App API.
...
We strive to foster a positive and inclusive community. Please be respectful and follow our [Code of Conduct](https://github.com/navedrasul/danacore-crm-integration-api/blob/main/CODE_OF_CONDUCT.md).

Thank you for your contributions! Together, we can make DanaCore CRM Integration App API better for everyone.
